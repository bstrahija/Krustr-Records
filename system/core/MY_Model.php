 ...
 * @modified Boris Strahija <http://creolab.hr>
...
class MY_Model extends CI_Model
{
	...
	/**
	 * Automaticly update 'created_at' and 'updated_at' fields
	 *
	 * @var bool
	 */
	...
	{
		$data = $this->_update_timestamps($data);
	...
	public function insert_many($data, $skip_validation = FALSE)
	{
		...
		foreach ($data as $row)
		{
			$row = $this->_update_timestamps($row);
	...
	{
		$data = $this->_update_updated_at($data);
	...
	*/
	 ...
	 */
	private function _update_created_at($data = NULL)
	{
	 ...
	 * @author Boris Strahija
	 */
	private function _update_updated_at($data = NULL)
	{
		if ( ! isset($data['updated_at'])) $data['updated_at'] = time();
	 ...
	 * @author Boris Strahija
	 */
	private function _update_timestamps($data = NULL)
	{
		$data = $this->_update_created_at($data);
		$data = $this->_update_updated_at($data);
